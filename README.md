...
```
git clone https://github.com/AKKPP/ChessCoin032-for-Android-operating-systems.git
cd ChessCoin032-for-Android-operating-systems
npm install
```
...
3. Open `build.gradle` file under `ChessCoin032-for-Android-operating-systems/android/` folder
